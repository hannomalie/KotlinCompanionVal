...
public class IrJsCodegenBoxTestGenerated extends AbstractIrJsCodegenBoxTest {
    ...
    @TestMetadata("compiler/testData/codegen/box/companionval")
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class Companionval extends AbstractIrJsCodegenBoxTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest0(this::doTest, TargetBackend.JS_IR, testDataFilePath);
        }

        public void testAllFilesPresentInCompanionval() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/codegen/box/companionval"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.JS_IR, true);
        }
    }
