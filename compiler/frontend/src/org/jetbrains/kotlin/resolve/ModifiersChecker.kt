...
object ModifierCheckerCore {
    ...
    val possibleTargetMap = mapOf<KtModifierKeywordToken, Set<KotlinTarget>>(
        ...
        COMPANION_KEYWORD to EnumSet.of(OBJECT, MEMBER_PROPERTY, TOP_LEVEL_PROPERTY, VALUE_PARAMETER, PROPERTY_PARAMETER, LOCAL_VARIABLE, PROPERTY),
    ...
    private val possibleParentTargetPredicateMap = mapOf<KtModifierKeywordToken, TargetAllowedPredicate>(
        ...
        COMPANION_KEYWORD to always(CLASS_ONLY, INTERFACE, ENUM_CLASS, ANNOTATION_CLASS, FUNCTION, CONSTRUCTOR, FILE),
